  ...
  return (
    // <div id="about" className='bg-gradient-to-tr from-green-600 via-emerald-300 to-yellow-400 p-5 md:grid md:grid-cols-3'>
     <div id="about" className=' py-10'> 
      ...
      <div>
        <h1 className='sm:text-xl md:text-3xl font-bold'>5 +</h1> <p>Experience</p>  
      </div>
        </div>
        <a className='bg-orange-500 rounded-md px-4 py-2 mx-8' href={resume} download>Download Resume</a>
      </div> 
    </div>
    </div>
        {/* tect stack icons */}
